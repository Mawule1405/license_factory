package com.taurustechnology.backend.initialization;
...
public class AppUserInitializer {
    ...
    private static final String SUPER_ADMIN_ROLE_NAME = "ADMINISTRATOR";
    ...
    private AppRole ensureSuperAdminRoleExists() {
        ...
        if (appRole == null) {
            throw new IllegalStateException(
                    "ADMINISTRATOR role not found after initialization");
        }
